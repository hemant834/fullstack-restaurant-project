...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center justify-between mb-8">
        <div>
            <h2 class="text-3xl font-bold text-white">Edit Menu Item</h2>
            <p class="text-gray-400 mt-1">Refine your creation</p>
        </div>
    ...
    <div class="bg-gray-800 rounded-lg shadow-xl border border-gray-700 overflow-hidden">
        <form action="{{ route('admin.menus.update', $menu->id) }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $menu->name) }}" required class="w-full bg-gray-900 border border-gray-700 rounded-lg py-2.5 px-4 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all">
                ...
                <div class="col-span-2 md:col-span-1 relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="price" id="price" value="{{ old('price', $menu->price) }}" required class="w-full bg-gray-900 border border-gray-700 rounded-lg py-2.5 pl-8 px-4 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all">
                    </div>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <select name="category" id="category" required class="w-full bg-gray-900 border border-gray-700 rounded-lg py-2.5 px-4 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all appearance-none cursor-pointer">
                        <option value="Starters" {{ old('category', $menu->category) == 'Starters' ? 'selected' : '' }}>Starters</option>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <div class="flex space-x-4 mt-1">
                        <label class="flex items-center space-x-2 cursor-pointer group">
                            <input type="radio" name="food_type" value="veg" class="form-radio text-green-500 bg-gray-900 border-gray-700 focus:ring-green-500" {{ old('food_type', $menu->food_type) == 'veg' ? 'checked' : '' }}>
                            <span class="text-gray-300 group-hover:text-white transition-colors">Veg</span>
                        </label>
                        <label class="flex items-center space-x-2 cursor-pointer group">
                            <input type="radio" name="food_type" value="non-veg" class="form-radio text-red-500 bg-gray-900 border-gray-700 focus:ring-red-500" {{ old('food_type', $menu->food_type) == 'non-veg' ? 'checked' : '' }}>
                            <span class="text-gray-300 group-hover:text-white transition-colors">Non-Veg</span>
                        </label>
                        <label class="flex items-center space-x-2 cursor-pointer group">
                            <input type="radio" name="food_type" value="egg" class="form-radio text-yellow-500 bg-gray-900 border-gray-700 focus:ring-yellow-500" {{ old('food_type', $menu->food_type) == 'egg' ? 'checked' : '' }}>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3" class="w-full bg-gray-900 border border-gray-700 rounded-lg py-2.5 px-4 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all">{{ old('description', $menu->description) }}</textarea>
                ...
                <div class="col-span-2">
                    ...
                    @if($menu->image)
                        <div class="mb-2">
                            <img src="{{ Str::startsWith($menu->image, 'http') ? $menu->image : asset('storage/' . $menu->image) }}" alt="Current Image" class="h-24 w-24 object-cover rounded-lg">
                        </div>
                    @endif
                ...
                <div class="col-span-2">
                    <label class="flex items-center space-x-3 cursor-pointer group">
                        <div class="relative">
                            <input type="checkbox" name="is_available" class="sr-only peer" {{ old('is_available', $menu->is_available) ? 'checked' : '' }}>
